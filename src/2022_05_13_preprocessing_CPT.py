...
df.describe().to_excel(Path(ROOT,'Data/processed/basic_statistics.xlsx'))
...
plt.tight_layout()
plt.savefig(Path(ROOT,"Figures/feature_histograms.png"))
...
np.save(Path(ROOT,'Data/processed/CPT_X_train.npy'), X_train)
np.save(Path(ROOT,'Data/processed/CPT_y_train.npy'), y_train)
np.save(Path(ROOT,'Data/processed/CPT_X_test.npy'), X_test)
np.save(Path(ROOT,'Data/processed/CPT_y_test.npy'), y_test)
